...
//	private final String PAR_SHEETS = "-sheets";
	...
	private void showHelp() {
		System.out.println("代码生成器 v0.5 使用说明");
		System.out.println("Copyright 2015 yanglb All Rights Reserved.");
		System.out.println();
...
//		System.out.println(" cg -type db -lang java -in 001.xlsx -sheets S001_配置表,S002_配置明细表 -out ./out");
	...
	private ParamaModel convert2Model(String[] args) {
		...
		// DDL/DML时只可能是SQL
		if(model.getType() == SupportType.ddl_mysql || model.getType() == SupportType.dml) {
